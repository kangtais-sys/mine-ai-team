  ...
  try {
    ...
    if (event === 'comment.received' && comment) {
      ...
      if (isEventComment(text)) {
        const eventReplies = [
          '다음 이벤트도 준비할게요! 항상 많은 사랑 감사합니다 💕',
          '이벤트 참여해주신 모든 분들 감사해요 🙏 다음에 또 좋은 이벤트로 찾아올게요!',
          '항상 관심 가져주셔서 감사합니다 ☺️ 또 이벤트 준비하러 총총..',
          '와주신 모든 분들 감사해요 💫 다음 이벤트도 기대해주세요!',
          '참여해주셔서 진심으로 감사드려요 🤍 금방 또 이벤트로 돌아올게요!',
          '많은 참여 감사합니다 🥰 다음엔 더 좋은 이벤트 준비해볼게요!',
          '다들 참여해주셔서 감사해요 💐 또 이벤트 준비하러 가볼게요~',
          '항상 사랑해주셔서 감사합니다 🌸 다음 이벤트도 많이 기대해주세요!',
        ];
